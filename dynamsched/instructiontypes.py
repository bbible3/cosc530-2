...
class DefaultInstructionTypes:
    def default_instruction_types():
        ...
        instruction_types.add(InstructionClass.FLOATING_POINT, "fadd.s", description="Floating Point Add Single", num_params=3, latency=4)
        instruction_types.add(InstructionClass.FLOATING_POINT, "fsub.s", description="Floating Point Subtract Single", num_params=3, latency=4)
        instruction_types.add(InstructionClass.FLOATING_POINT, "fmul.s", description="Floating Point Multiply Single", num_params=3, latency=4)
        instruction_types.add(InstructionClass.FLOATING_POINT, "fdiv.s", description="Floating Point Divide Single", num_params=3, latency=4)
